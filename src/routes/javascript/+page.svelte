<script>
  const chapters = [
    {
      title: "Chapter 1: Introduction to JavaScript & Setting Up",
      topics: [
        "What is JavaScript?",
    ...
    },
    {
      ...
      topics: [
        "Introduction to Closures and Module Pattern",
...
<div class="container">
  ...
  <p class="intro">Master modern JavaScript from basics to advanced concepts</p>
